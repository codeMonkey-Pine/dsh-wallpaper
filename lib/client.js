...
`;
		...
		*/
		...
		function MediaElement(props) {
			...
			if (entry.type === "video") media = react.default.createElement("video", {
				src: mediaUrl,
			...
			}, react.default.createElement("div", { style: innerStyle }, media), note !== void 0 ? react.default.createElement("div", { className: "wp-type-note" }, note) : null);
		}
